...
import { WINDOW_NAMES, MAIN_WIN_SIZE, MENU_IDS, CONVERSATION_LIST_MENU_IDS, CONVERSATION_ITEM_MENU_IDS, IPC_EVENTS } from '@common/constants';
import { windowManager } from '../service/WindowService';
import { menuManger } from '@main/service/MenuService';
...
const registerMenus = (window: BrowserWindow) => {
  ...
  menuManger.register(MENU_IDS.CONVERSATION_ITEM, [
    {
  ...
  menuManger.register(MENU_IDS.CONVERSATION_LIST, [
    {
